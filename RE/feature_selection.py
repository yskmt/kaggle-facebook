...
if __name__ == '__main__':
    ...
    elif 'bids-count-by-bots' in argv[1]:
        info_humans = pd.read_csv('data/info_humans.csv', index_col=0)
        info_bots = pd.read_csv('data/info_bots.csv', index_col=0)
        info_test = pd.read_csv('data/info_test.csv', index_col=0)
    ...
    # Bids interval data
        ...
        keys_bi = ['2', '8', '1', '10', '3', '7', '4', '9', '58', '6',
                   '0', '11', 'num_devices', '12', 'num_bids', '20', '5',
                   'num_ips', '18', '19', 'num_countries', 'num_aucs', '13',
                   '27', 'num_urls', '21', '15', '22', '16', '17', '26', '46',
                   '25', '64', '30', '14', '52', '23', '61', '29', '36', '32',
                   '34', '50', '24', '38', '67', '39', '54', '31', '35', '53',
                   '57', '62', '37', '60', '33', '43', '28', '81', '55', '70',
                   '76', '47', '72', '40', '49', '79', '93', '66', '78', '56',
                   '82', '86', '74', '45', '41', '48', '59', '87', '68', '92',
                   '85', '73', '44', '91', '94', '42', '97', '63', '77', '71',
                   '98', '84', '90', '88', '80', '83', '75', '99', '65', '96',
                   '51', '89', '95', '69', 'num_merchs']
